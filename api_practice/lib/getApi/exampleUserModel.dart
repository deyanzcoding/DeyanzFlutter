                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                         ...
                         ReusableRow(title: 'Geo-lat', value: snapshot.data![index].address!.geo!.lat.toString()),
                         ReusableRow(title: 'Geo-lng', value: snapshot.data![index].address!.geo!.lng.toString()),
                        ],
                      ),
                    ),
                  );
